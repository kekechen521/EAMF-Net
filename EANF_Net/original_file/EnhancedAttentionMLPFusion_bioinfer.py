...
##################################################### 训练循环 ####################################################
best_epoch=0
print("Starting training with EnhancedAttentionWeightedMLPFusion_bioinfer model...")
...
for epoch in range(epochs):
    ...
    if dev_f1 > best_f1:
        ...
        }, 'best_attention_fusion_model_bioinfer.pth')
...
# 加载最佳模型
checkpoint = torch.load('best_attention_fusion_model_bioinfer.pth', weights_only=False)
